...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(30222972653325286)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(30249236321325409)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(30249527234325409)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(30250042276325410)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Page Help'
,p_list_item_link_target=>'f?p=&APP_ID.:10011:&APP_SESSION.::&DEBUG.::P10011_PAGE_ID:&APP_PAGE_ID.'
,p_list_item_icon=>'fa-question-circle-o'
,p_parent_list_item_id=>wwv_flow_imp.id(30249527234325409)
,p_list_text_02=>'icon-only'
,p_required_patch=>wwv_flow_imp.id(30225467279325313)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(30250434957325410)
