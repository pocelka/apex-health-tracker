...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(45244914743562137)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28864340593559234)
,p_plug_template_id=>wwv_flow_api.id(45244914743562137)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28864842486559234)
,p_plug_template_id=>wwv_flow_api.id(45244914743562137)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
