...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50822941420160234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21000815742746857)
,p_plug_template_id=>wwv_flow_imp.id(50822941420160234)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21001399221746857)
,p_plug_template_id=>wwv_flow_imp.id(50822941420160234)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21001802382746857)
,p_plug_template_id=>wwv_flow_imp.id(50822941420160234)
,p_name=>'Sub Regions'
