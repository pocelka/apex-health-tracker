...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(45249164574562138)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28840907571559229)
,p_plug_template_id=>wwv_flow_api.id(45249164574562138)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28841393085559229)
,p_plug_template_id=>wwv_flow_api.id(45249164574562138)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
