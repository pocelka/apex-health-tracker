...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(65865269224281379)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21065921215746878)
,p_plug_template_id=>wwv_flow_imp.id(65865269224281379)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21066436332746879)
,p_plug_template_id=>wwv_flow_imp.id(65865269224281379)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21066953010746879)
,p_plug_template_id=>wwv_flow_imp.id(65865269224281379)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21067487093746879)
,p_plug_template_id=>wwv_flow_imp.id(65865269224281379)
,p_name=>'Sub Regions'
