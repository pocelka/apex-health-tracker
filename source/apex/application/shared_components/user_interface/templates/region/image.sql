...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21170132275746910)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21170658890746910)
,p_plug_template_id=>wwv_flow_imp.id(21170132275746910)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21171159725746910)
,p_plug_template_id=>wwv_flow_imp.id(21170132275746910)
,p_name=>'Sub Regions'
