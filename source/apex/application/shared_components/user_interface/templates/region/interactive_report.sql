...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3930561222203306)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3931050227203306)
,p_plug_template_id=>wwv_flow_imp.id(65866996810281379)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3931546862203307)
,p_plug_template_id=>wwv_flow_imp.id(65866996810281379)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3932088571203307)
,p_plug_template_id=>wwv_flow_imp.id(65866996810281379)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3932583903203307)
,p_plug_template_id=>wwv_flow_imp.id(65866996810281379)
,p_name=>'Sub Regions'
