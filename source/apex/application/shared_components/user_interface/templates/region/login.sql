...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3935960209203308)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3936493067203308)
,p_plug_template_id=>wwv_flow_imp.id(65867264563281379)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3936934806203308)
,p_plug_template_id=>wwv_flow_imp.id(65867264563281379)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3937484017203308)
,p_plug_template_id=>wwv_flow_imp.id(65867264563281379)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3937907617203308)
,p_plug_template_id=>wwv_flow_imp.id(65867264563281379)
,p_name=>'Sub Regions'
