...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86103035428570449)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24171731074492378)
,p_plug_template_id=>wwv_flow_imp.id(86103035428570449)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24172263932492378)
,p_plug_template_id=>wwv_flow_imp.id(86103035428570449)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24172705671492378)
,p_plug_template_id=>wwv_flow_imp.id(86103035428570449)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24173254882492378)
,p_plug_template_id=>wwv_flow_imp.id(86103035428570449)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24173678482492378)
,p_plug_template_id=>wwv_flow_imp.id(86103035428570449)
,p_name=>'Sub Regions'
