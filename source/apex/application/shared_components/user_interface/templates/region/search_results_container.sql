...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3997892130203333)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3998363615203334)
,p_plug_template_id=>wwv_flow_imp.id(3997892130203333)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3998816296203334)
,p_plug_template_id=>wwv_flow_imp.id(3997892130203333)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3999372707203334)
,p_plug_template_id=>wwv_flow_imp.id(3997892130203333)
,p_name=>'Sub Regions'
