...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(45257721800562139)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28776453545559215)
,p_plug_template_id=>wwv_flow_api.id(45257721800562139)
,p_name=>'Tabs'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28776948278559215)
,p_plug_template_id=>wwv_flow_api.id(45257721800562139)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
