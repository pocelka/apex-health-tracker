...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86108057511570450)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24225433088492399)
,p_plug_template_id=>wwv_flow_imp.id(86108057511570450)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24225880169492399)
,p_plug_template_id=>wwv_flow_imp.id(86108057511570450)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24226469708492399)
,p_plug_template_id=>wwv_flow_imp.id(86108057511570450)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24226945070492399)
,p_plug_template_id=>wwv_flow_imp.id(86108057511570450)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24227405810492399)
,p_plug_template_id=>wwv_flow_imp.id(86108057511570450)
