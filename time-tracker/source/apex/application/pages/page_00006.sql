...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90191820027916303)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90192498800916305)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(86093686348570447)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90192221324916305)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(90192498800916305)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90192331165916305)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90186066060839099)
,p_name=>'P6_ICON_IMAGE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(90191820027916303)
,p_prompt=>'Icon Image'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>100
,p_field_template=>wwv_flow_imp.id(71193547216449380)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90186139712839100)
,p_name=>'P6_DESC_TEXT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(90191820027916303)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90194888575916310)
,p_name=>'P6_TASK_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(90191820027916303)
...
,p_cSize=>30
,p_cMaxlength=>100
,p_field_template=>wwv_flow_imp.id(71193795570449380)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90195276147916310)
,p_name=>'P6_PROJECT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(90191820027916303)
,p_prompt=>'Project'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90307959822155897)
...
,p_named_lov=>'YES_NO'
,p_lov=>'.'||wwv_flow_imp.id(90119564210349903)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90193213184916306)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(90192221324916305)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90193713957916307)
,p_event_id=>wwv_flow_imp.id(90193213184916306)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(90195615439916311)
...
,p_process_when_button_id=>wwv_flow_imp.id(90192331165916305)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(90196194101916311)
