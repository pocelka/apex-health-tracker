...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10891671715151916)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10892179784151924)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10892689910151925)
,p_plugin_attribute_id=>wwv_flow_imp.id(10892179784151924)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10893234190151926)
,p_plugin_attribute_id=>wwv_flow_imp.id(10892179784151924)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10893843262151927)
,p_plugin_attribute_id=>wwv_flow_imp.id(10892179784151924)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10894424397151928)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10892179784151924)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10894947432151928)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10894424397151928)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10895404972151929)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10895941166151929)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10896406900151929)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10896968683151930)
,p_plugin_attribute_id=>wwv_flow_imp.id(10896406900151929)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10897552725151930)
,p_plugin_attribute_id=>wwv_flow_imp.id(10896406900151929)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10898126173151930)
,p_plugin_attribute_id=>wwv_flow_imp.id(10896406900151929)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10898723817151931)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10899200471151931)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10899825706151931)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10900469118151932)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10901087548151932)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10901623450151933)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10902242728151933)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10902859777151933)
,p_plugin_attribute_id=>wwv_flow_imp.id(10898723817151931)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10903451553151934)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1810942722016265668)
,p_plugin_id=>wwv_flow_imp.id(10891671715151916)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
