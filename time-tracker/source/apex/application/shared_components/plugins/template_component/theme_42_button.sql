...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10932004908151969)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10932514516151970)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10933024308151970)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10933540925151970)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10934061281151971)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10934542935151971)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10935078187151971)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10935568473151972)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10936089520151972)
,p_plugin_id=>wwv_flow_imp.id(10932004908151969)
,p_attribute_scope=>'COMPONENT'
