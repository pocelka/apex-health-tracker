...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10915215419151955)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1810800886155183671)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10916138325151957)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10916651202151957)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10917120700151957)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10917660191151957)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10918141127151958)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10925390471151962)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1810800886155183671)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10918630363151958)
,p_plugin_attribute_id=>wwv_flow_imp.id(10918141127151958)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10919246053151958)
,p_plugin_attribute_id=>wwv_flow_imp.id(10918141127151958)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10919851857151959)
,p_plugin_attribute_id=>wwv_flow_imp.id(10918141127151958)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10920431217151959)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10918141127151958)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10920925026151959)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(10920431217151959)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10921482079151960)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10921972075151960)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10922438267151960)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10922922298151961)
,p_plugin_attribute_id=>wwv_flow_imp.id(10922438267151960)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10923597252151961)
,p_plugin_attribute_id=>wwv_flow_imp.id(10922438267151960)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10924164352151961)
,p_plugin_attribute_id=>wwv_flow_imp.id(10922438267151960)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10924728371151962)
,p_plugin_attribute_id=>wwv_flow_imp.id(10922438267151960)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10925390471151962)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10925812846151962)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10926342672151963)
,p_plugin_attribute_id=>wwv_flow_imp.id(10925812846151962)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10926902372151963)
,p_plugin_attribute_id=>wwv_flow_imp.id(10925812846151962)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10927570010151963)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1810933553588285174)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1810932962083277717)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1810988585753259596)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1811140803466130367)
,p_plugin_id=>wwv_flow_imp.id(10915215419151955)
