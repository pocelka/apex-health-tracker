...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10962441156151994)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1938200501873223696)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1938199946861223695)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10963776732152002)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10964272760152002)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10964732529152003)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10965272848152003)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10965739605152003)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10966201756152004)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10966751911152004)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10965739605152003)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1938200501873223696)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10967249006152004)
,p_plugin_attribute_id=>wwv_flow_imp.id(10966751911152004)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10967896035152004)
,p_plugin_attribute_id=>wwv_flow_imp.id(10966751911152004)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10968492345152005)
,p_plugin_attribute_id=>wwv_flow_imp.id(10966751911152004)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10969042357152005)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10966751911152004)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10969598987152005)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(10969042357152005)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10970026851152006)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10970541019152006)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10971061675152006)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10971581373152007)
,p_plugin_attribute_id=>wwv_flow_imp.id(10971061675152006)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10972114950152007)
,p_plugin_attribute_id=>wwv_flow_imp.id(10971061675152006)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10972700710152008)
,p_plugin_attribute_id=>wwv_flow_imp.id(10971061675152006)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10973309207152008)
,p_plugin_attribute_id=>wwv_flow_imp.id(10971061675152006)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10973907470152008)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(10966201756152004)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1938199946861223695)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10974413283152009)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10974935925152009)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10975469437152009)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10975904850152010)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10976416982152010)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10976930959152010)
,p_plugin_attribute_id=>wwv_flow_imp.id(10976416982152010)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10977530429152011)
,p_plugin_attribute_id=>wwv_flow_imp.id(10976416982152010)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10978165885152011)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10978646656152011)
,p_plugin_attribute_id=>wwv_flow_imp.id(10978165885152011)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10979221249152012)
,p_plugin_attribute_id=>wwv_flow_imp.id(10978165885152011)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10979837942152012)
,p_plugin_attribute_id=>wwv_flow_imp.id(10978165885152011)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10980499591152012)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10980981303152013)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10981553563152013)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10982151114152013)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10982710333152014)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10983325144152014)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10983937668152015)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10984522173152015)
,p_plugin_attribute_id=>wwv_flow_imp.id(10980499591152012)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10985124036152015)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10985649741152016)
,p_plugin_attribute_id=>wwv_flow_imp.id(10985124036152015)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10986245093152016)
,p_plugin_attribute_id=>wwv_flow_imp.id(10985124036152015)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10986813038152016)
,p_plugin_attribute_id=>wwv_flow_imp.id(10985124036152015)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10987420045152017)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10987916394152017)
,p_plugin_attribute_id=>wwv_flow_imp.id(10987420045152017)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10988590472152017)
,p_plugin_attribute_id=>wwv_flow_imp.id(10987420045152017)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10989144958152017)
,p_plugin_attribute_id=>wwv_flow_imp.id(10987420045152017)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10989711080152018)
,p_plugin_attribute_id=>wwv_flow_imp.id(10987420045152017)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10990305014152018)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1819414392089045310)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1819415651609049458)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1805820763414638577)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1806500064144721681)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1819412457022000324)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1819413790412014181)
,p_plugin_id=>wwv_flow_imp.id(10962441156151994)
