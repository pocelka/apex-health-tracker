...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10999693483152028)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1811017711460035676)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1811018266472035677)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11000973929152029)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11001417363152030)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11001958627152030)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11002468832152030)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11002952811152031)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11001958627152030)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1811018266472035677)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11003487497152031)
,p_plugin_attribute_id=>wwv_flow_imp.id(11002952811152031)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11004050771152031)
,p_plugin_attribute_id=>wwv_flow_imp.id(11002952811152031)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11004621001152032)
,p_plugin_attribute_id=>wwv_flow_imp.id(11002952811152031)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11005271952152032)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11002952811152031)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11005733241152032)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(11005271952152032)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11006217551152033)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11006714305152033)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11007242413152034)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11007740566152034)
,p_plugin_attribute_id=>wwv_flow_imp.id(11007242413152034)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11008305716152034)
,p_plugin_attribute_id=>wwv_flow_imp.id(11007242413152034)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11008997574152035)
,p_plugin_attribute_id=>wwv_flow_imp.id(11007242413152034)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11009509922152035)
,p_plugin_attribute_id=>wwv_flow_imp.id(11007242413152034)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11010139216152035)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(11002468832152030)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1811017711460035676)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11010621326152036)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11011116866152036)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11011601944152036)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11012132558152037)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11012615579152037)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11013161094152037)
,p_plugin_attribute_id=>wwv_flow_imp.id(11012615579152037)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11013731721152038)
,p_plugin_attribute_id=>wwv_flow_imp.id(11012615579152037)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11014380650152038)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11014812758152038)
,p_plugin_attribute_id=>wwv_flow_imp.id(11014380650152038)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11015496593152039)
,p_plugin_attribute_id=>wwv_flow_imp.id(11014380650152038)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11016054933152039)
,p_plugin_attribute_id=>wwv_flow_imp.id(11014380650152038)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11016665076152039)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11017142967152040)
,p_plugin_attribute_id=>wwv_flow_imp.id(11016665076152039)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11017701270152040)
,p_plugin_attribute_id=>wwv_flow_imp.id(11016665076152039)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11018347279152041)
,p_plugin_attribute_id=>wwv_flow_imp.id(11016665076152039)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11018947257152041)
,p_plugin_attribute_id=>wwv_flow_imp.id(11016665076152039)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11019593915152041)
,p_plugin_attribute_id=>wwv_flow_imp.id(11016665076152039)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11020199994152042)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11020611060152042)
,p_plugin_attribute_id=>wwv_flow_imp.id(11020199994152042)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11021222740152042)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1811221318629182305)
,p_plugin_id=>wwv_flow_imp.id(10999693483152028)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
