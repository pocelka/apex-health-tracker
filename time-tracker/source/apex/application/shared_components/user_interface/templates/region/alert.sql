...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86091461196570445)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24053404110492336)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24053897136492336)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24054434944492336)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24054964582492336)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24055457111492337)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24055899379492337)
,p_plug_template_id=>wwv_flow_imp.id(86091461196570445)
,p_name=>'Sub Regions'
