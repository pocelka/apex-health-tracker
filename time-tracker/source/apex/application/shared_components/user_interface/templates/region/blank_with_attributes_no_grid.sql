...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96184489654835878)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10552196465151618)
,p_plug_template_id=>wwv_flow_imp.id(96184489654835878)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10552645458151618)
,p_plug_template_id=>wwv_flow_imp.id(96184489654835878)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10553160948151618)
,p_plug_template_id=>wwv_flow_imp.id(96184489654835878)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10553632261151618)
,p_plug_template_id=>wwv_flow_imp.id(96184489654835878)
,p_name=>'Sub Regions'
