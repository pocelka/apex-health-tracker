...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86093398501570447)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24069156079492342)
,p_plug_template_id=>wwv_flow_imp.id(86093398501570447)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24069666384492342)
,p_plug_template_id=>wwv_flow_imp.id(86093398501570447)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24070075573492342)
,p_plug_template_id=>wwv_flow_imp.id(86093398501570447)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24070606780492342)
,p_plug_template_id=>wwv_flow_imp.id(86093398501570447)
,p_name=>'Sub Regions'
