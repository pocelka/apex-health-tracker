...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71058712285449304)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24047163494492334)
,p_plug_template_id=>wwv_flow_imp.id(71058712285449304)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24047585715492334)
,p_plug_template_id=>wwv_flow_imp.id(71058712285449304)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24048110215492334)
,p_plug_template_id=>wwv_flow_imp.id(71058712285449304)
,p_name=>'Sub Regions'
