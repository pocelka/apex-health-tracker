...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81149803438714735)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10566720912151627)
,p_plug_template_id=>wwv_flow_imp.id(81149803438714735)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10567208275151627)
,p_plug_template_id=>wwv_flow_imp.id(81149803438714735)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10567733415151628)
,p_plug_template_id=>wwv_flow_imp.id(81149803438714735)
,p_name=>'Sub Regions'
