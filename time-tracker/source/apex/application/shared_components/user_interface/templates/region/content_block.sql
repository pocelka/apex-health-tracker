...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96191259834835879)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10623684598151668)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10624141224151669)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10624681771151669)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10625191313151669)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10625659631151670)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10626162677151670)
,p_plug_template_id=>wwv_flow_imp.id(96191259834835879)
,p_name=>'Sub Regions'
