...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96192131242835880)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10633928446151677)
,p_plug_template_id=>wwv_flow_imp.id(96192131242835880)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634444419151678)
,p_plug_template_id=>wwv_flow_imp.id(96192131242835880)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10634919796151678)
,p_plug_template_id=>wwv_flow_imp.id(96192131242835880)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10635464487151678)
,p_plug_template_id=>wwv_flow_imp.id(96192131242835880)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10635931165151679)
,p_plug_template_id=>wwv_flow_imp.id(96192131242835880)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
