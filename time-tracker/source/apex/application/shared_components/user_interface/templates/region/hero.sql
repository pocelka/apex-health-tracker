...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86101040089570449)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24146671813492370)
,p_plug_template_id=>wwv_flow_imp.id(86101040089570449)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24147218520492370)
,p_plug_template_id=>wwv_flow_imp.id(86101040089570449)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24147675391492370)
,p_plug_template_id=>wwv_flow_imp.id(86101040089570449)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24148186420492370)
,p_plug_template_id=>wwv_flow_imp.id(86101040089570449)
,p_name=>'Sub Regions'
