...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51496994294301411)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10641416500151683)
,p_plug_template_id=>wwv_flow_imp.id(51496994294301411)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10641918863151683)
,p_plug_template_id=>wwv_flow_imp.id(51496994294301411)
,p_name=>'Sub Regions'
