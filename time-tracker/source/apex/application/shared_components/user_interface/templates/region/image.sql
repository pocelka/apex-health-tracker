...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(41405903141035980)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24019445558492324)
,p_plug_template_id=>wwv_flow_imp.id(41405903141035980)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24019938666492324)
,p_plug_template_id=>wwv_flow_imp.id(41405903141035980)
,p_name=>'Sub Regions'
