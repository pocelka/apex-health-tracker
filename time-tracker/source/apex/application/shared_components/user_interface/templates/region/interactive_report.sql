...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96193858828835880)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10693684285151724)
,p_plug_template_id=>wwv_flow_imp.id(96193858828835880)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10694184453151724)
,p_plug_template_id=>wwv_flow_imp.id(96193858828835880)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10694616933151724)
,p_plug_template_id=>wwv_flow_imp.id(96193858828835880)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10695173767151724)
,p_plug_template_id=>wwv_flow_imp.id(96193858828835880)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10695675430151725)
,p_plug_template_id=>wwv_flow_imp.id(96193858828835880)
,p_name=>'Sub Regions'
