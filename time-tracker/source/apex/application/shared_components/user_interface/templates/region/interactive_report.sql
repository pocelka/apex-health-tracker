...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86102767675570449)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24166332087492376)
,p_plug_template_id=>wwv_flow_imp.id(86102767675570449)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24166821092492376)
,p_plug_template_id=>wwv_flow_imp.id(86102767675570449)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24167317727492377)
,p_plug_template_id=>wwv_flow_imp.id(86102767675570449)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24167859436492377)
,p_plug_template_id=>wwv_flow_imp.id(86102767675570449)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24168354768492377)
,p_plug_template_id=>wwv_flow_imp.id(86102767675570449)
,p_name=>'Sub Regions'
