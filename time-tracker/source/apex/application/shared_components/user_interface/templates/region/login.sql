...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96194126581835880)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10705090323151732)
,p_plug_template_id=>wwv_flow_imp.id(96194126581835880)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10705503684151732)
,p_plug_template_id=>wwv_flow_imp.id(96194126581835880)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10706090179151732)
,p_plug_template_id=>wwv_flow_imp.id(96194126581835880)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10706520343151732)
,p_plug_template_id=>wwv_flow_imp.id(96194126581835880)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10707039685151733)
,p_plug_template_id=>wwv_flow_imp.id(96194126581835880)
,p_name=>'Sub Regions'
