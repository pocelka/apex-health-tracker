...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34324754148757834)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10710824915151736)
,p_plug_template_id=>wwv_flow_imp.id(34324754148757834)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10711380827151736)
,p_plug_template_id=>wwv_flow_imp.id(34324754148757834)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10711868887151736)
,p_plug_template_id=>wwv_flow_imp.id(34324754148757834)
,p_name=>'Sub Regions'
