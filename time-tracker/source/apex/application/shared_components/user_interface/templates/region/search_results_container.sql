...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(24233662995492403)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24234134480492404)
,p_plug_template_id=>wwv_flow_imp.id(24233662995492403)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24234587161492404)
,p_plug_template_id=>wwv_flow_imp.id(24233662995492403)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24235143572492404)
,p_plug_template_id=>wwv_flow_imp.id(24233662995492403)
,p_name=>'Sub Regions'
