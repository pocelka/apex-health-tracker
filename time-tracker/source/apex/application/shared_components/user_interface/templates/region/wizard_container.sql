...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(96199148664835881)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10765530448151776)
,p_plug_template_id=>wwv_flow_imp.id(96199148664835881)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10766040206151777)
,p_plug_template_id=>wwv_flow_imp.id(96199148664835881)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10766580973151777)
,p_plug_template_id=>wwv_flow_imp.id(96199148664835881)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10767002738151777)
,p_plug_template_id=>wwv_flow_imp.id(96199148664835881)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10767536587151777)
,p_plug_template_id=>wwv_flow_imp.id(96199148664835881)
